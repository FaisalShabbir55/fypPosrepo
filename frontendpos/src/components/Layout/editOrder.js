...
const EditOrderForm = () => {
  ...
  const handleSelectProduct = (product) => {
    ...
    const existingItemIndex = orderData.items.findIndex((item) => item.productName === product.ProductName)
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="form-grid">
            <div className="form-group">
              ...
              <select name="workerId" value={orderData.workerId} onChange={handleFormChange} required>
            ...
            <div className="form-group">
              ...
              <input type="date" name="date" value={orderData.date} onChange={handleFormChange} required />
            </div>
          </div>
          ...
          <div className="form-grid">
            <div className="form-group">
              ...
              <input
                ...
                onChange={handleFormChange}
                placeholder="Cash, Card, Cheque, etc."
              />
            </div>
          </div>
          ...
          <div className="product-search">
            <input
              ...
              placeholder="Search and add products to this order..."
            />
            {productSuggestions.length > 0 && (
              <ul className="suggestions">
                {productSuggestions.map((product, i) => (
                  <li key={i} onClick={() => handleSelectProduct(product)}>
                    <strong>{product.ProductName}</strong> - Stock: {product.Stock} - Price: ${product.Price}
                  </li>
                ))}
              </ul>
            )}
              ...
              {orderData.items.length === 0 && (
                <tr>
                  <td colSpan="6" style={{ textAlign: "center", padding: "40px", color: "#94a3b8" }}>
                    No items in this order. Add products using the search above.
                  </td>
                </tr>
              )}
            </tbody>
          ...
          <div className="form-grid">
            ...
            <div className="form-group">
              ...
              <input type="number" name="tax" value={orderData.tax} onChange={handleFormChange} step="0.01" min="0" />
            </div>
            <div className="form-group">
            ...
            <div className="form-group">
              ...
              <input type="number" name="paid" value={orderData.paid} onChange={handleFormChange} step="0.01" min="0" />
            </div>
          </div>
          ...
          <div className="totals-section">
            ...
            <p>
              ...
              <strong style={{ color: orderData.remaining > 0 ? "#ef4444" : "#10b981" }}>
                ${orderData.remaining.toFixed(2)}
              </strong>
            </p>
          </div>
          ...
          <div className="button-group">
            ...
            <button type="button" className="cancel-btn" onClick={() => navigate("/order-List")}>
              🚫 Discard Changes
            </button>
          </div>
        </form>
